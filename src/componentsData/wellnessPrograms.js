export const wellnessProgramsData = [
  ...
  export const wellnessProgramsData2 = [
    "4 weekly approximately one hour virtual sessions with Em",
  ...
  export const wellnessProgramsData3 = [
    "8 weekly approximately one hour virtual sessions with Em. If desired, 1 of the sessions can be a virtual cook-along to increase comfort & joy in the kitchen!",
    "Check-ins and support with Em via email &/or text in between sessions at a frequency of your choosing",
    "Resources including recipes, guide sheets, information regarding plant-based events, & more",
  ];
  
  export const wellnessProgramsData4 = [
    "12 weekly approximately one hour virtual sessions with Em. If desired, 1 of the sessions can be a virtual cook-along to increase comfort & joy in the kitchen!",
    "Check-ins and support with Em via email &/or text in between sessions at a frequency of your choosing",
    "Resources including recipes, guide sheets, information regarding plant-based events, & more",
  ];
