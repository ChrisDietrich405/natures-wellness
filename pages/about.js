      ...
      >
        ...
        <div className={styles.about_intro}>
          ...
          <div className={styles.about_intro_text}>
            ...
            <p>
              ...
              Type 2 Diabetes, kidney failure, and others. I felt at a loss of
              how to help them which led me to want to find a way to help
              prevent others from suffering this same fate. Finding a way to
              help empower, educate, and support individuals on their journeys
        ...
        <div className={styles.content_text}>
          <p>
            ...
            is our health. Though our genes play a role in our health, their
            role is small compared to the role that healthful lifestyle
            practices have on our physical and mental wellbeing. Healthy
            lifestyle practices that have a positive impact on our physical and
            mental wellbeing include the following. I denote them as SPARC to
            help us ignite these practices in our life to achieve our optional
            physical and mental wellbeing:
          </p>
          <p style={{ marginTop: "20px" }}>
            <List data={aboutData2} />
            Stress-management and self care Plant-based nutrition and purpose
            Adequate hydration and physical activity Restorative sleep
            Connection and community
          </p>
          <p style={{ marginBottom: "20px" }}>
            In addition to being the most effective, healthy, and sustainable
            way to lose weight and maintain weight loss, some health issues that
            are effectively addressed by embracing these practices or doing our
            best to do so include:
          </p>
