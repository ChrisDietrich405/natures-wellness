...
// import { wellnessProgramsData } from "./wellnessPrograms";
// import { wellnessProgramsData2 } from "./wellnessPrograms";
    ...
    <main className="inner-container">
      <div className={styles.wellness_container}>
        ...
        {/* <List data={wellnessProgramsData} className={styles.offering_list} /> */}
          ...
          <div className={styles.path}>
            <p>Path #3: 12 Week Program: longest program option, ideal for those who are l</p>
