        ...
        <div className={styles.about_intro}>
          ...
          <div className={styles.about_intro_text}>
            ...
            <p>
              ...
              reduced quality of life in men and women, some as young as myself
              at the time (late 20s) due to debilitating diseases like stroke,
              Type 2 Diabetes, kidney failure, and others.
            </p>
            <p>
              I felt at a loss of how to help them which led me to want to find
              a way to help prevent others from suffering this same fate.
              Finding a way to help empower, educate, and support individuals on
              their journeys to achieving optimal health became my passion and
              something I feel so grateful to be able to do!
            </p>
          </div>
        </div>
        <div className={styles.content_text}>
          <Card sx={{ mt: 3 }} className={styles.content_paragraph}>
            <p>
            ...
            <Grid item lg={6}>
              <Card sx={{ mt: 3 }} className={styles.content_paragraph}>
                ...
                <p style={{ marginBottom: "20px" }}>
                  ...
                  sustainable way to lose weight and maintain weight loss, some
                  health issues that are effectively addressed by embracing
                  these practices or doing our best to do so include:
                </p>
                <div className={styles.list_container}>
            ...
            <Grid item lg={6}>
              ...
              >
                <p style={{ marginBottom: "10px" }}>
                  ...
                  best lives is our health. Though our genes play a role in our
                  health, their role is small compared to the role that
                  healthful lifestyle practices have on our physical and mental
                  wellbeing.{" "}
                </p>
                <p style={{ marginBottom: "20px" }}>
                  {" "}
                  Healthy lifestyle practices that have a positive impact on our
                  physical and mental wellbeing include the following. I denote
                  them as SPARC to help us ignite these practices in our life to
                  achieve our optional physical and mental wellbeing:{" "}
                </p>
                <div className={styles.list_container}>
